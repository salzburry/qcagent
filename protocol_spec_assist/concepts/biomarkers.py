...
class BiomarkersExtraction(BaseModel):
    chain_of_thought: str = Field(default="", description="Think step by step about the biomarkers in the protocol text. Identify which biomarkers are explicitly mentioned, note any specific definitions, and assess your confidence before structuring the answer.")
